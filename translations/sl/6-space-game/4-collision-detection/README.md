...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:44:26+00:00",
...
[Kviz pred predavanjem](https://ashy-river-0debb7803.1.azurestaticapps.net/quiz/35)

V tej lekciji se boste naučili, kako streljati laserje z JavaScriptom! V igro bomo dodali dve stvari:

- **Laser**: laser, ki ga izstreli ladja junaka in se premika navpično navzgor
...
Na kratko, vi -- *junak* -- morate zadeti vse sovražnike z laserjem, preden dosežejo spodnji del zaslona.

✅ Raziščite prvi računalniški program za igro, ki je bil kdaj napisan. Kakšna je bila njegova funkcionalnost?
...
Za uničenje stvari v igri morate igri sporočiti, da določenega predmeta ne sme več risati v zanki igre, ki se sproži v določenem intervalu. To lahko storite tako, da označite igralni objekt kot *mrtev*, ko se zgodi nekaj, na primer:
...
Laser se mora izstreliti vsakič, ko pritisnete tipko, na primer *preslednico*. Da preprečimo, da bi igra v kratkem času ustvarila preveč laserjev, moramo to popraviti. Popravek je implementacija tako imenovane *časovne omejitve*, časovnika, ki zagotavlja, da se laser lahko izstreli le ob določenih intervalih. To lahko implementirate na naslednji način:
...
Vzemite obstoječo kodo (ki ste jo morali očistiti in preoblikovati) iz prejšnje lekcije in jo razširite. Lahko začnete s kodo iz drugega dela ali uporabite kodo na [Part III- starter](../../../../../../../../../your-work).
...
2. **Dodajte kodo, ki preverja trke** To bo nova funkcija, ki preverja, ali se dva pravokotnika prekrivata:
...
3. **Dodajte sposobnost streljanja laserja**
   ...
   1. **Premik objekta**, Poskrbite, da se laser postopoma premika proti vrhu zaslona. Ustvarili boste nov razred Laser, ki razširja `GameObject`, kot ste to storili prej: 
...
[Kviz po predavanju](https://ashy-river-0debb7803.1.azurestaticapps.net/quiz/36)
