...
Sprejemanje odločitev in nadzor nad vrstnim redom izvajanja kode omogočata, da je vaša koda ponovno uporabna in robustna. Ta razdelek pokriva sintakso za nadzor pretoka podatkov v JavaScriptu ter njen pomen pri uporabi z Boolean podatkovnimi tipi.
...
| Simbol | Opis                                                                                     | Primer                                                                 |
| ------ | ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `&&`   | **Logični AND**: Primerja dve Boolean izraza. Vrne true **samo**, če sta obe strani true | `(5 > 6) && (5 < 6 ) //Ena stran je false, druga je true. Vrne false` |
| `\|\|` | **Logični OR**: Primerja dve Boolean izraza. Vrne true, če je vsaj ena stran true        | `(5 > 6) \|\| (5 < 6) //Ena stran je false, druga je true. Vrne true` |
