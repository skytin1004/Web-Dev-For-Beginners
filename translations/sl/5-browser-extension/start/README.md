...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:32:27+00:00",
  "source_file": "5-browser-extension/start/README.md",
  "language_code": "sl"
}
-->
# Razširitev brskalnika Carbon Trigger: Začetna koda

Z uporabo tmrow-ovega API-ja C02 Signal za sledenje porabi električne energije zgradite razširitev za brskalnik, ki vam bo omogočila opomnik neposredno v brskalniku o tem, kako obremenjena je poraba električne energije v vaši regiji. Občasna uporaba te razširitve vam bo pomagala pri sprejemanju odločitev glede vaših dejavnosti na podlagi teh informacij.
