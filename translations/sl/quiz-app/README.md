...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-28T00:07:11+00:00",
...
Dodajte prevod kviza tako, da ustvarite ustrezne strukture kvizov v mapah `assets/translations`. Izvirni kvizi so v `assets/translations/en`. Kvizi so razdeljeni v več skupin. Poskrbite, da bo številčenje usklajeno z ustreznim delom kviza. V tem učnem načrtu je skupno 40 kvizov, pri čemer se šteje od 0 naprej.
...
Na primer, če je vaš prevod JSON v `ex.json`, nastavite 'ex' kot ključ za lokalizacijo, nato ga vnesite, kot je prikazano spodaj, da ga uvozite.
...
- Prednastavitve gradnje: Azure Static Web Apps uporablja algoritem za zaznavanje okvira, uporabljenega v vaši aplikaciji. 
...
Ko je GitHub Action (delovni tok) uspešno izveden, osvežite stran v živo, da si ogledate svojo aplikacijo.
