...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:41:14+00:00",
...
| --------- | ----------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------- |
|           | Kód `app.js` je plne okomentovaný a organizovaný do logických blokov | Kód `app.js` je primerane okomentovaný | Kód `app.js` je čiastočne neorganizovaný a chýbajú mu dobré komentáre |
