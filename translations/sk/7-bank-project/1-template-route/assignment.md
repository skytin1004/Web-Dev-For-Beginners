...
- Pridajte možnosť spustiť nejaký kód po zmene šablóny. Chceme, aby sa v konzole vývojára zobrazilo `'Dashboard is shown'` vždy, keď sa zobrazí stránka dashboardu.
