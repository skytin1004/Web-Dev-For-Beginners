...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:16:42+00:00",
...
Međutim, ako želite naučiti kako izgraditi API poput ovog, možete pratiti ovu seriju videa: https://aka.ms/NodeBeginner (videozapisi od 17 do 21 pokrivaju upravo ovaj API).
...
*Ovaj server će raditi zajedno s glavnim terminalom aplikacije banke (slušajući na portu `3000`), nemojte ga zatvarati.*

> Napomena: svi unosi se pohranjuju u memoriji i nisu trajni, tako da se svi podaci gube kada se server zaustavi.
